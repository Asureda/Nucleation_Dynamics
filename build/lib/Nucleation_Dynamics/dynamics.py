...
class ClusterDynamics:
    ...
    def update_clusters_with_boundary_condition_closed(cluster_array, forward_rate_array, backward_rate_array, dt, i_max, initial_N1):
        ...
        return updated_cluster_array, changes
    ...
    def simulate(self):
        ...
        for step in range(self.time_steps):
            self.cluster_array, changes = self.update_clusters_with_boundary_condition_closed(self.cluster_array, self.forward_rate_array, self.backward_rate_array, self.dt, self.i_max,self.cluster_array[0])
